...
- [Sessions](/concepts/sessions/overview)
- [User Memories](/concepts/memory/overview)
...
Agents with a `db` will persist their [sessions](/concepts/sessions/overview) in the database. You can also automatically add the persisted history to the context, effectively enabling Agents to persist sessions:
