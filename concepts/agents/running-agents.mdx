...
<Tip>
    ...
    See the [Input & Output](/concepts/input_output/overview) docs for more information, and to see how to use structured input and output with agents.
...
- `metrics`: The metrics of the run. For more details see [Metrics](/concepts/sessions/metrics/overview).
...
For more information see the [Agent Sessions](/concepts/sessions/overview) documentation.
